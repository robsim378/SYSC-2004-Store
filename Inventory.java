...
public class Inventory {
    ...
    private class ProductStock {
         ...
         * @param product The product stored as a Product.
         ...
         * @return The product stored as a Product.
         */
         ...
         * @param product The Product to be put into the ProductStock.
         */
    ...
    /**
     * Constructor for an Inventory. Creates an empty ArrayList of ProductStocks.
     */
    public Inventory() {
